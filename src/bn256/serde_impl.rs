...
impl<'de> Deserialize<'de> for super::SecretKeyShare {
    ...
    where
        D: Deserializer<'de>,
    {
        Ok(super::SecretKeyShare(Deserialize::deserialize(
            deserializer,
        )?))
    }
}
...
mod tests {
    ...
    use super::super::poly::BivarPoly;
    use super::super::{Fr, G1};
    ...
    fn serde_secret_key() {
        use super::super::serde_impl::SerdeSecret;
    ...
    fn serde_secret_key_share() {
        use super::super::serde_impl::SerdeSecret;
        use super::super::SecretKeyShare;
        use rand::{thread_rng, Rng};
